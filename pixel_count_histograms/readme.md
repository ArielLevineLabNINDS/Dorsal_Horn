...
Processing of pixel-count histograms exported from Fiji (using outputs of Plot Profile) are described in the [R markdown](TBD). The pipeline is paraphrased below:
